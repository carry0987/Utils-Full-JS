...
class Utils {
    ...
    // executeUtils
    static debounce: typeof UtilsModule.executeUtils.debounce = UtilsModule.executeUtils.debounce;
    static throttle: typeof UtilsModule.executeUtils.throttle = UtilsModule.executeUtils.throttle;
    // storageUtils
